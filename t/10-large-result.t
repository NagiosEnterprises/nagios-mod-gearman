...
# start worker
my $cmd = "./nagios-mod-gearman-worker --server=localhost:$TESTPORT --debug=4 --max-worker=1 --encryption=off --daemon --pidfile=./worker.pid --logfile=$LOGFILE";
system($cmd);
