...
/** \mainpage Nagios-Mod-Gearman
 *
 * \section intro_sec Introduction
 *
 * Nagios-Mod-Gearman (https://www.nagios.org/projects/nagios-mod-gearman/) is a
 * way of distributing active Nagios checks (https://www.nagios.org) across your network. It
 ...
 *
 * @attention Please submit bugreports or patches on https://github.com/NagiosEnterprises/nagios-mod-gearman/
 * @author Nagios Development Team <devteam@nagios.com>
 *
 */
...
/* neb module */
    ...
    int            do_hostchecks;                           /**< flag whether nagios-mod-gearman will process hostchecks at all */
    int            route_eventhandler_like_checks;          /**< flag whether nagios-mod-gearman will route like normal checks */
