...
#define MOD_GM_WORKER   /**< set nagios-mod-gearman-worker features */
...
/** @file
 *  @brief Nagios-Mod-Gearman Worker Client
 *  @addtogroup nagios_mod_gearman_worker Worker
 *
